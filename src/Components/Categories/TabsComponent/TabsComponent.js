...
const TabsComponent = () => {
  ...
  const [selectedTab, setSelectedTab] = useState(3); // Initially select the first tab
      ...
      {tabs.map((tab, index) => (
        <div
          ...
          style={{
            ...
            zIndex: selectedTab === index ? '1000' : index ==  (selectedTab - 1) ? '1111' : '1', // Double the width for the selected tab
